...
import com.project.genassist_ecommerce.databinding.ActivitySellerDashboardBinding
import com.project.genassist_ecommerce.databinding.DialogAddProductsBinding
                ...
                selectedImagePath==null -> showToast("Please select the image from the gallery")
                    ...
                    CoroutineScope(IO).async{
                        contentResolver.openInputStream(selectedImagePath!!)?.readBytes()?.let{ it: ByteArray ->
                            RetrofitInstance.instance.AddItem(name1, Base64.encodeToString(
                                it, Base64.NO_WRAP
                            ), priceStr,id, name, rating).enqueue(object :
